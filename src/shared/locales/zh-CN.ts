...
export const ZH_CN_MESSAGES = {
    ...
    "settings.manual": "手动",
    "ai.panel.diff_summary": "查看与当前笔记的差异",
    "ai.panel.replace_selection": "替换选中内容",
    "ai.panel.copy": "复制结果",
    "settings.ai_fetch_models": "获取模型列表",
    "settings.ai_models_available": "可用模型",
    "settings.ai_models_pick": "选择一个模型…",
    "ai.action.ask": "问答我的笔记",
    "navigation.tasks": "任务",
    "navigation.calendar": "日历",
    "tasks.title": "未完成任务",
    "tasks.refresh": "刷新",
    "tasks.empty_title": "暂无未完成任务",
    "tasks.empty_desc": "在任意笔记里写 `- [ ]` 开头的行，就会汇总到这里",
    "calendar.title": "日历",
    "calendar.previous_month": "上个月",
    "calendar.next_month": "下个月",
    "calendar.pick_a_day": "点击带圆点的日期查看当天笔记",
    "calendar.no_notes_that_day": "这一天没有创建过笔记",
    "calendar.create_note_for_day": "为这一天新建笔记",
    "notes.untitled": "无标题",
    "templates.new_from_template": "从模板新建",
    "templates.save_current": "把当前笔记存为模板",
    "templates.user_section": "我的模板",
    "templates.saved_toast": "模板已保存：{name}",
    "templates.name_placeholder": "模板名称",
    "folders.publish_as_blog": "发布为博客页面",
    "folders.blog_published_toast": "博客页面已发布 — 链接已复制到剪贴板",
    "folders.blog_publish_failed": "博客页面发布失败",
    "workspace.encrypt_note": "加密笔记…",
    "workspace.decrypt_note": "解密笔记…",
    "workspace.crypto_passphrase": "口令",
    "workspace.crypto_encrypt_hint": "正文会先在浏览器内用 AES-GCM 加密再保存。搜索与 AI 无法读取加密笔记。口令无法找回，请牢记。",
    "workspace.crypto_decrypt_hint": "输入口令以在编辑器中解密该笔记正文。",
    "workspace.crypto_wrong_passphrase": "口令错误",
    "workspace.crypto_failed": "解密失败",
    "settings.restore_latest": "恢复最近备份",
    "settings.restore_done_toast": "恢复完成 — 已写入 {value0} 条笔记",
    "settings.restore_failed": "恢复失败",
    "settings.ai_custom_instructions": "固定指令",
    "settings.ai_custom_instructions_hint": "附加到每次 AI 请求，如语气、术语、面向读者等，最长 2000 字",
    "settings.ai_custom_instructions_placeholder": "例如：保持书面语气；术语以我的笔记为准…",
    ...
    "share.toggle_theme": "切换主题",
    "share.loading": "加载中…",
    "share.blog": "博客",
    "share.post_count": "{count} 篇文章",
    ...
    "ai.panel.empty_hint": "可以就当前笔记提问，或使用上方快捷操作。全文操作会通过版本历史可回溯的保存写回笔记。",
    "ai.panel.apply_to_note": "将最近结果写回笔记",
    "ai.panel.input_placeholder": "就这篇笔记提问…",
    "ai.panel.send": "发送",
    "ai.panel.quota_chars": "字符/今日",
    "ai.panel.context_note": "所有请求由本服务代理，密钥不会离开服务器",
    "ai.action.polish": "润色",
    "ai.action.expand": "扩写",
    "ai.action.shorten": "精简",
    "ai.action.translate_zh": "译成中文",
    "ai.action.translate_en": "译成英文",
    "ai.action.explain": "解释",
    "ai.action.formal": "正式语气",
    "ai.action.casual": "口语语气",
    "ai.action.summarize": "总结全文",
    "ai.action.title": "拟定标题",
    "ai.action.tags": "建议标签",
    "ai.action.continue": "续写",
    "ai.error.ai_not_configured": "AI 助手尚未配置。请在 设置 → AI 中开启。",
    "ai.error.ai_quota_exceeded": "今日 AI 配额已用完。可在 设置 → AI 中调整。",
    "ai.error.ai_busy": "已有一个 AI 请求正在进行。",
    "ai.error.ai_unavailable": "AI 服务调用失败。请重试或在设置中切换提供商。",
    "ai.error.http_403": "登录已过期，请刷新后重试。",
    "ai.error.unknown": "AI 请求失败。",
    "settings.ai": "AI",
    "settings.ai_enable": "启用 AI 助手",
    "settings.ai_enable_description": "在编辑器右侧添加助手面板、快捷操作与选区工具",
    "settings.ai_provider": "提供商",
    "settings.ai_provider_workers": "Workers AI",
    "settings.ai_provider_openai": "OpenAI 兼容",
    "settings.ai_base_url": "API 端点",
    "settings.ai_api_key": "API 密钥",
    "settings.ai_api_key_stored": "已加密保存一个密钥；输入可替换",
    "settings.ai_api_key_hint": "加密保存在凭据保险库中，绝不明文落库",
    "settings.ai_model": "模型",
    "settings.ai_quota": "每日字符配额",
    "settings.ai_quota_description": "此账号每天 AI 输入+输出字符的上限",
    "settings.ai_usage": "今日用量",
    "settings.ai_usage_unknown": "登录后可查看 AI 用量",
    "settings.ai_privacy_note": "你的 API 密钥加密存储，永不下发浏览器。",
    "settings.ai_proxy_note": "所有 AI 请求均由本服务代理。",
    "settings.mcp": "MCP",
