export const EN_US_MESSAGES = {
    ...
    "ai.panel.diff_summary": "Show changes vs current note",
    "ai.panel.replace_selection": "Replace selection",
    "ai.panel.copy": "Copy result",
    "settings.ai_fetch_models": "Fetch model list",
    "settings.ai_models_available": "Available models",
    "settings.ai_models_pick": "Pick a model…",
    "ai.action.ask": "Ask my notes",
    "navigation.tasks": "Tasks",
    "navigation.calendar": "Calendar",
    "tasks.title": "Open tasks",
    "tasks.refresh": "Refresh",
    "tasks.empty_title": "No open tasks",
    "tasks.empty_desc": "Add `- [ ]` lines in any note and they will show up here",
    "calendar.title": "Calendar",
    "calendar.previous_month": "Previous month",
    "calendar.next_month": "Next month",
    "calendar.pick_a_day": "Pick a day with a dot to see its notes",
    "calendar.no_notes_that_day": "No notes created on this day",
    "calendar.create_note_for_day": "Create a note for this day",
    "notes.untitled": "Untitled",
    "templates.new_from_template": "New from template",
    "templates.save_current": "Save current note as template",
    "templates.user_section": "My templates",
    "templates.saved_toast": "Template saved: {name}",
    "templates.name_placeholder": "Template name",
    "folders.publish_as_blog": "Publish as blog page",
    "folders.blog_published_toast": "Blog page published — URL copied to clipboard",
    "folders.blog_publish_failed": "Could not publish the blog page",
    "workspace.encrypt_note": "Encrypt note…",
    "workspace.decrypt_note": "Decrypt note…",
    "workspace.crypto_passphrase": "Passphrase",
    "workspace.crypto_encrypt_hint": "The note body is encrypted in this browser with AES-GCM before saving. Search and AI features cannot read encrypted notes. Remember the passphrase: it cannot be recovered.",
    "workspace.crypto_decrypt_hint": "Enter the passphrase to decrypt this note body in the editor.",
    "workspace.crypto_wrong_passphrase": "Wrong passphrase",
    "workspace.crypto_failed": "Decryption failed",
    "settings.restore_latest": "Restore latest",
    "settings.restore_done_toast": "Restore complete — {value0} notes written",
    "settings.restore_failed": "Restore failed",
    "settings.ai_custom_instructions": "Standing instructions",
    "settings.ai_custom_instructions_hint": "Added to every AI request, e.g. tone, terminology, or audience. Max 2000 characters",
    "settings.ai_custom_instructions_placeholder": "e.g. Keep a professional tone; use the glossary in my notes…",
    ...
    "share.toggle_theme": "Toggle theme",
    "share.loading": "Loading…",
    "share.blog": "Blog",
    "share.post_count": "{count} posts",
    ...
    "ai.panel.empty_hint": "Ask about this note, or use a quick action above. Full-text actions replace the note via version-tracked saves.",
    "ai.panel.apply_to_note": "Apply last result to note",
    "ai.panel.input_placeholder": "Ask anything about this note…",
    "ai.panel.send": "Send",
    "ai.panel.quota_chars": "chars today",
    "ai.panel.context_note": "Requests are proxied by this server; keys never leave it",
    "ai.action.polish": "Polish",
    "ai.action.expand": "Expand",
    "ai.action.shorten": "Shorten",
    "ai.action.translate_zh": "To Chinese",
    "ai.action.translate_en": "To English",
    "ai.action.explain": "Explain",
    "ai.action.formal": "Formal tone",
    "ai.action.casual": "Casual tone",
    "ai.action.summarize": "Summarize",
    "ai.action.title": "Suggest title",
    "ai.action.tags": "Suggest tags",
    "ai.action.continue": "Continue writing",
    "ai.error.ai_not_configured": "AI assistant is not configured. Enable it in Settings → AI.",
    "ai.error.ai_quota_exceeded": "Daily AI quota exhausted. Adjust it in Settings → AI.",
    "ai.error.ai_busy": "Another AI request is already running.",
    "ai.error.ai_unavailable": "The AI provider failed. Try again or switch providers in settings.",
    "ai.error.http_403": "Session expired. Refresh and try again.",
    "ai.error.unknown": "The AI request failed.",
    "settings.ai": "AI",
    "settings.ai_enable": "Enable AI assistant",
    "settings.ai_enable_description": "Adds the right-side assistant panel, quick actions, and selection tools in the editor",
    "settings.ai_provider": "Provider",
    "settings.ai_provider_workers": "Workers AI",
    "settings.ai_provider_openai": "OpenAI-compatible",
    "settings.ai_base_url": "API endpoint",
    "settings.ai_api_key": "API key",
    "settings.ai_api_key_stored": "A key is stored encrypted; type to replace it",
    "settings.ai_api_key_hint": "Stored encrypted in the credential vault, never in plain text",
    "settings.ai_model": "Model",
    "settings.ai_quota": "Daily character quota",
    "settings.ai_quota_description": "Upper bound of AI input+output characters per day for this account",
    "settings.ai_usage": "Usage today",
    "settings.ai_usage_unknown": "Sign in to see AI usage",
    "settings.ai_privacy_note": "Your API key is stored encrypted and never returned to the browser.",
    "settings.ai_proxy_note": "All AI requests are proxied by this server.",
    "settings.mcp": "MCP",
